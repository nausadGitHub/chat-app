...
export class AuthenticationService {
        // urls
        registration = 'http://192.168.36.106:8080/api/v1/auth/signup';
        login = 'http://192.168.36.106:8080/api/v1/auth/login';
        forget = 'http://192.168.36.106:8080/api/v1/auth/forgot-password';
        reset = 'http://192.168.36.106:8080/api/v1/auth/reset-password';
        otpVerify = 'http://192.168.36.106:8080/api/v1/auth/otp-verification';
        otpResend = 'http://192.168.36.106:8080/api/v1/users/otp-resend';
        changeUrl = 'http://192.168.36.106:8080/api/v1/users/user-change-password';
